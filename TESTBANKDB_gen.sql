...
CREATE TABLE IF NOT EXISTS `testbank`.`questions` (
  ...
  PRIMARY KEY (`qstn_id`, `category_category_id`),
  INDEX `fk_questions_category1_idx` (`category_category_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `testbank`.`answers` (
  ...
  `ans_qstn` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `testbank`.`questions_has_tests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testbank`.`questions_has_tests` (
  `questions_qstn_id` INT NOT NULL,
  `tests_test_id` INT NOT NULL,
  `tests_users_user_id` INT NOT NULL,
  PRIMARY KEY (`questions_qstn_id`, `tests_test_id`, `tests_users_user_id`),
